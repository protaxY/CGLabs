...
namespace CG
{
    class MainWindow : Window
    {
        ...
        public MainWindow() : this(new Builder("CGLab5.glade"))
        {
        ...
        private void GLInit(object sender, EventArgs args)
        {
            ...
            string vertexShaderSource = ReadFromRes(@"CGLab5.shader.vert");
            ...
            string polygonNormalsGeometryShaderSource = ReadFromRes(@"CGLab5.polygon_normals.geom");
            ...
            string fragmentShaderSource = ReadFromRes(@"CGLab5.shader.frag");
