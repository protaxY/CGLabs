...
namespace CG
{
    class MainWindow : Window
    {
        ...
        public MainWindow() : this(new Builder("CGLab6.glade"))
        {
        ...
        private void GLInit(object sender, EventArgs args)
        {
            ...
            string vertexShaderSource = ReadFromRes(@"CGLab6.shader.vert");
            ...
            string polygonNormalsGeometryShaderSource = ReadFromRes(@"CGLab6.polygon_normals.geom");
            ...
            string fragmentShaderSource = ReadFromRes(@"CGLab6.shader.frag");
            ...
            glArea.Render += (o, args) =>
            {
                ...
                gl.Uniform3(scaleLocation, (float) _a.Value, (float) _b.Value, (float) _c.Value);
